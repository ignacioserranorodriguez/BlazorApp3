...
CREATE TABLE `Device` (
  ...
  `TransmitterId` int DEFAULT NULL,
  `Url` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  PRIMARY KEY (`Id`),
  KEY `IX_Device_TransmitterId` (`TransmitterId`),
  CONSTRAINT `FK_Device_Device_TransmitterId` FOREIGN KEY (`TransmitterId`) REFERENCES `Device` (`Id`) ON DELETE RESTRICT
...
-- Dump completed on 2024-09-04 16:17:34
