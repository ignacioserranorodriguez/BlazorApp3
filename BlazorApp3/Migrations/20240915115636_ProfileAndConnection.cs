...
{
    /// <inheritdoc />
    public partial class ProfileAndConnection : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Connection_Device_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "Device",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Connection_Device_TransmitterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Connection_TransmitterId",
                table: "Connection",
